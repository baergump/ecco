...
public class ExperimentRunConfiguration{
    ...
    // TODO: write a test for this (not enough variants; no variants; non-existent folder, etc)
    // TODO: write a test to make sure that not only the first X tests are chosen
    public void pickVariants(){
        // TODO: make sure there are (enough) variants
    ...
    public List<String> getFeatures(){
        // TODO: features can be gathered without variant pick
